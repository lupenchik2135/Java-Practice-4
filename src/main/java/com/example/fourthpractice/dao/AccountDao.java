...
//        return accountRepository.findByUser(accountOwner).isPresent();
//    }
//    public void deleteAccount(UserEntity accountOwner, UUID accountId){
//        if(isAccountExist(accountOwner) && accountRepository.findByUser(accountOwner).get().getAccountId() == accountId) {
//            accountRepository.delete(accountRepository.findByUser(accountOwner).orElseThrow());
//        }
//    }
